  ...
  return (
    <div className="flex justify-center flex-col ">
      ...
      <form className="mx-auto w-1/3">
        ...
        <input
          className="file:mt-3 file:h-20 file:w-full file:rounded-lg file:border-none file:bg-white/5 px-3 py-1.5 file:text-sm/6 text-whiteblock w-full text-sm text-gray-500"
          type="file"
          id="image"
          name="image"
        />
        ...
        <label htmlFor="genre">
          ...
          <Select
            ...
            name="genre"
          >
            <option className="mt-3 block w-full rounded-lg border-none bg-white/5 px-3 py-1.5 text-sm/6 text-white">
              Fantasy
            </option>
            <option className="mt-3 block w-full rounded-lg border-none bg-white/5 px-3 py-1.5 text-sm/6 text-white">
              Crime
